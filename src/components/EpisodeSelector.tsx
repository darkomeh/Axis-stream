...
const EpisodeSelectorComponent = ({ 
 ...
 className="relative flex items-center gap-5 pl-6 pr-8 py-3.5 bg-black/40 backdrop-blur-3xl rounded-3xl border border-white/5 hover:bg-[#181818]/60 transition-all group overflow-hidden"
 >
 {/* Subtle Glow Borders */}
 ...
 <span className="text-fluid-xs font-semibold text-white/40 tracking-[0.3em]">Selection</span>
 <span className="text-fluid-xl font-semibold text-white tracking-tight group-hover:text-brand transition-colors">
 ...
 className={`flex-shrink-0 w-16 h-16 rounded-full border transition-all text-center relative overflow-hidden flex flex-col justify-center items-center group/card active:scale-95 ${ isActive ? 'bg-brand border-brand shadow-[0_0_30px_rgba(229,9,20,0.4)]' : 'bg-white/5 border-white/10 hover:border-white/30 hover:bg-white/10 backdrop-blur-md' }`}
 >
 <span className={`block text-fluid-2xl font-semibold tracking-tight transition-all leading-none ${isActive ? 'text-white scale-110' : 'text-white/40 group-hover/card:text-white'}`}>
 {ep}
 </span>
 ...
 <div className="pt-4">
 <div className="p-8 rounded-3xl bg-black/40 backdrop-blur-3xl border border-white/5 flex items-center justify-between group cursor-pointer hover:bg-[#181818]/60 transition-all">
 <div className="flex-1">
 <div className="flex items-center gap-4 mb-3">
 <span className="text-fluid-sm font-semibold text-white tracking-wide bg-brand px-3 py-1.5 rounded-lg shadow-lg">Current</span>
 <h4 className="text-white font-semibold text-fluid-xl tracking-tight scale-y-110">
 {activeEpInfo.title}
 </h4>
 </div>
 <div className="flex items-center gap-2.5 text-fluid-sm font-bold text-white/30 tracking-wide leading-none">
 ...
 <div className="w-14 h-14 rounded-full bg-black/40 backdrop-blur-3xl border border-brand/50 flex items-center justify-center shadow-2xl relative z-10">
 ...
 <p className="text-gray-500 text-fluid-sm tracking-wide font-semibold opacity-40">Collection List</p>
 <p className="text-white/60 text-fluid-sm font-medium">Pick a volume to dive back into the story</p>
 </div>
 ...
 className={`group relative w-full h-24 rounded-2xl border transition-all overflow-hidden flex items-center justify-between px-8 active:scale-[0.99] duration-300 ${ isActive ? 'border-brand bg-black/40 backdrop-blur-3xl shadow-[0_0_30px_rgba(229,9,20,0.15)] shadow-brand/5' : 'bg-white/5 border-white/5 hover:border-white/20 hover:bg-white/10 backdrop-blur-md' }`}
 >
 ...
 <span className={`text-fluid-base font-semibold tracking-[0.4em] ${isActive ? 'text-brand' : 'text-white/30'}`}>Season</span>
 <span className={`text-fluid-5xl font-semibold tracking-tight leading-none ${isActive ? 'text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]' : 'text-white/40 group-hover:text-white'}`}>
 {s.se.toString().padStart(2, '0')}
 </span>
 </div>

 <div className="relative z-10 flex flex-col items-end gap-1">
 <span className="text-fluid-sm font-bold text-white/40 tracking-wide">{s.maxEp} Episodes</span>
 {isActive && (
 <div className="flex items-center gap-2 px-3 py-1 bg-brand rounded-full">
 <Play className="w-3 h-3 fill-white" strokeWidth={0} />
 <span className="text-fluid-xs font-semibold tracking-wider">Watching</span>
 </div>
 )}
 </div>
