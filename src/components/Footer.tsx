      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-12">
          <Link to="/" className="flex items-center gap-3 mb-6 group">
            <div className="w-12 h-12 rounded-full bg-brand flex items-center justify-center shadow-[0_0_20px_rgba(255,45,45,0.4)] transition-transform group-hover:scale-110 duration-500">
          ...
          <p className="text-gray-400 text-[15px] leading-relaxed max-w-2xl font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-16">
          <a 
            ...
            className="flex items-center justify-between p-6 bg-[#121212] border border-white/5 rounded-2xl group hover:border-brand/40 transition-all duration-300"
          >
            <div className="flex items-center gap-6">
              <div className="w-14 h-14 rounded-2xl bg-[#1D2B1D] flex items-center justify-center text-[#4ADE80] group-hover:scale-110 transition-transform">
                <MessageCircle className="w-8 h-8 fill-current" />
              </div>
              <div>
                <h4 className="text-white font-black uppercase text-sm tracking-widest mb-1">WhatsApp Channel</h4>
                <p className="text-gray-500 text-xs font-bold leading-tight">Join our channel for<br />updates & news</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-6">
              <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center text-brand group-hover:scale-110 transition-transform">
                <Headphones className="w-8 h-8" />
              </div>
              <div>
                <h4 className="text-white font-black uppercase text-sm tracking-widest mb-1">Contact Dev</h4>
                <p className="text-gray-500 text-xs font-bold leading-tight">Need help or want to<br />build a site like this?</p>
              </div>
            </div>
            <ArrowRight className="w-5 h-5 text-brand group-hover:translate-x-2 transition-transform" />
          </a>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <h3 className="text-white font-black uppercase text-[15px] tracking-[0.2em] relative inline-block">
              Explore
              <div className="absolute -bottom-2 left-0 w-8 h-[3px] bg-brand" />
            </h3>
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/browse" className="flex items-center gap-3 text-gray-500 hover:text-white transition-colors group">
                  ...
                  <span className="text-sm font-bold uppercase tracking-widest">Browse</span>
                </Link>
              </li>
              <li>
                <Link to="/ranking" className="flex items-center gap-3 text-gray-500 hover:text-white transition-colors group">
                  ...
                  <span className="text-sm font-bold uppercase tracking-widest">Rankings</span>
                </Link>
              </li>
              <li>
                <Link to="/live" className="flex items-center gap-3 text-gray-500 hover:text-white transition-colors group">
                  ...
                  <span className="text-sm font-bold uppercase tracking-widest">Live Sports</span>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-[#121212] border border-white/5 rounded-2xl p-6 mb-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-6 text-center md:text-left">
            <div className="w-16 h-16 rounded-full bg-brand/10 flex items-center justify-center text-brand shrink-0 animate-pulse shadow-[0_0_20px_rgba(255,45,45,0.2)]">
              <Crown className="w-8 h-8" />
            </div>
            <div>
              <h4 className="text-white font-black uppercase text-base tracking-widest mb-1 italic">Want to create a site like AXIS TV?</h4>
              <p className="text-gray-500 text-[13px] font-bold leading-relaxed max-w-xl">
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full md:w-auto px-10 py-4 bg-transparent border border-brand/40 text-brand font-black uppercase tracking-widest text-[11px] rounded-xl hover:bg-brand/5 transition-all text-center"
          >
            Contact Dev
          </a>
        </div>
