      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-md bg-[#121212] border border-white/10 rounded-2xl p-8 relative shadow-2xl"
          ...
          >
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col gap-3">
                <button
                  onClick={onConfirm}
                  className="w-full py-4 bg-brand text-white rounded-lg font-black uppercase tracking-widest text-sm hover:bg-brand-hover transition-all shadow-[0_0_20px_rgba(229,9,20,0.3)]"
                >
                  Create Your Account
                </button>
                <button
