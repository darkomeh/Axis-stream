...
export default function SystemAlerts() {
 ...
 if (isBanned) {
 return (
 <div className="fixed inset-0 z-[100] bg-transparent flex items-center justify-center p-6 text-center">
 ...
 <div>
 <h1 className="text-fluid-4xl font-semibold tracking-tight mb-4">Account Suspended</h1>
 ...
 <div className="pt-8">
 <p className="text-fluid-sm font-semibold tracking-wide text-gray-700">ErrorCode: AX_BAN_403</p>
 </div>
 </div>
 </div>
 );
 ...
 <div>
 <h1 className="text-fluid-4xl font-semibold tracking-tight mb-4">Under Maintenance</h1>
 <p className="text-gray-500 font-medium leading-relaxed">
 ...
 <span className="text-fluid-sm font-semibold tracking-wide text-gray-400">Lockdown Active</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <p className="text-fluid-xs font-semibold tracking-wide text-white/60 mb-0.5">Platform Broadcast</p>
 <p className="text-fluid-sm font-bold text-white leading-tight truncate">{systemMessage}</p>
 </div>
 </div>
 </motion.div>
 )}
