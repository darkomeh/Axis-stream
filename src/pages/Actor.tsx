...
export default function ActorPage() {
 ...
 <h2 className="text-fluid-2xl font-bold mb-4">Actor not found</h2>
 ...
 <div className="flex items-center gap-3 text-fluid-xs font-bold tracking-wide text-gray-500">
 <User className="w-4 h-4" />
 <span>Actor Profile</span>
 </div>
 <h1 className="text-fluid-4xl font-semibold tracking-tight">{actor.name}</h1>
 <div className="flex flex-wrap items-center gap-4 text-fluid-sm font-medium text-gray-400">
 ...
 <div className="space-y-4">
 <h3 className="font-bold tracking-wide text-gray-500 text-fluid-lg">Biography</h3>
 <p className="text-fluid-lg text-gray-300 leading-relaxed line-clamp-6 md:line-clamp-none">
 ...
 <h2 className="text-fluid-3xl font-bold tracking-tight">Filmography</h2>
 <div className="flex items-center gap-2 text-gray-500 text-fluid-sm font-bold tracking-wide">
 ...
 <span className="text-fluid-sm font-semibold tracking-wide">Fetching more works...</span>
 </div>
 )}
 </div>
 )}
 ...
 <div className="px-4 sm:px-6 lg:px-12 max-w-[1400px] mx-auto py-12">
 <h2 className="text-fluid-3xl font-bold mb-8 tracking-tight">Related Actors</h2>
 ...
 <p className="font-bold text-fluid-sm group-hover:text-white transition-colors">{rel.name}</p>
 </div>
 </Link>
 ))}
 </div>
