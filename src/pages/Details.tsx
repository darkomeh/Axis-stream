...
export default function Details() {
 ...
 if (user) {
 const itemMedia = await movieService.getPlay(id, s, e, itemDetails.detailPath);
 ...
 const itemMedia = await movieService.getPlay(id, s, e, details?.detailPath);
 ...
 try {
 setMediaData(null);
 const itemMedia = await movieService.getPlay(subjectId, selectedSeason, selectedEpisode, details?.detailPath);
 setMediaData(itemMedia);
 } catch (err) {
