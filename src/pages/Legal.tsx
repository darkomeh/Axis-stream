...
export default function Legal() {
 ...
 return (
 <div className="min-h-screen bg-transparent text-white px-6 py-12 md:px-12 md:py-24">
 <div className="max-w-3xl mx-auto space-y-8">
 <Link to="/" className="inline-flex items-center gap-2 text-gray-400 hover:text-white transition-colors">
 <ArrowLeft className="w-5 h-5" />
 <span className="text-fluid-sm font-bold tracking-wide">Back to Home</span>
 </Link>
 
 <div className="glass-panel rounded-3xl p-8 md:p-12 shadow-2xl">
 <h1 className="text-fluid-3xl font-semibold tracking-tight mb-8">{policy.title}</h1>
