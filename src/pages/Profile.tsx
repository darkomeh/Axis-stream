...
export default function Profile() {
  ...
  const handleSaveProfile = () => {
    if (editUsername && editEmail) {
      // In a real app, we would update the Firestore document here
      showToast("Profile updates are handled automatically via sync", "info");
        ...
        <div className="flex-1 flex items-center justify-center p-6 relative z-10">
          ...
          >
            ...
            <form onSubmit={handleAuth} className="space-y-5">
              ...
              <div className="space-y-1">
                <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest px-2">Password</label>
                <input 
                  type="password" 
                  value={password}
