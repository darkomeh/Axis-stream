...
async function run() {
  ...
  // Need a subjectId. Let's use 301533 (Dune Part Two) or whatever we can find. Or we can just use 1?
  // I will just use '301533' or 'movie/batman'
  const testEndpoints = [
    { name: 'Play', pathMain: '/play', pathBackup: '/playback', params: { subjectId: '1' } },
  ];
